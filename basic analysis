...
8.	用户对于安装完毕的智能化家用系统并没特别的感觉，eg. 更方便，更安全，更随意
智能化家用系统是否真的让用户切实体会到了方便和舒适。
9.	智能化家用系统（IoT系统）VS智能化家电（IoT设备/家电）
...
二者均是用于无线通讯，主要区别在于使用场景和通讯方式。BLUETOOTH可以无需网线直接连接设备/家电，而WIFI则需要一部分网线，却可以高速连接互联网。
  ...
  2.	WIFI可以连接所有在同一局域内的设备，而且有效距离则远的多，理论上可以达到将近90米，同时，WIFI的通讯速度、安全性和拓展性会更强。
12.	智能化家用系统VS智能化建筑系统
在节能方面，智能化建筑系统可以表现的更加出色，在这一点上看，其实智能化家用系统，或者商用系统，还是非常有市场。
13.	如何有效远程控制
手机app或者手机如何通过互联网连接到用户自己的家中。
14.	智能手机未来趋势，特别是应用这一块，是否会出现统一平台，或者是否可以制作这样一个平台等待时机？
15.	需要的专业知识很多，电力、网络、各种程序、硬件、电器工作原理。
16.	隐私问题

驱动：
1.	家庭安全的市场需求
2.	DIY开始围绕Google Home, Samsung SmartThings Hub, Amazon’s Echo, etc
3.	能耗管理系统，统计各电器的能量消耗
4.	保险公司的介入
5.	从更大的角度来看，智能化城市也是一个非常好的命题
6.	省钱
...
2.	DIY型
  a.	智能设备
  b.	按需作业
    i.	空调、温控、HVAC(Heating, Ventilation and AirConditioning)
    ii.	电视机（常年失踪的遥控器，还是用手机代替吧）-> 可以实现，还没研究透
	1.	Smart TV
	2.	Traditional Remote Control TV
iii.	娱乐系统
iv.	监控、感应设备
v.	门
vi.	照明 - >可以实现，简单
